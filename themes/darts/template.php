...
function darts_preprocess_page(&$vars, $hook) {
  ...
  //Check for admin
  drupal_add_js(drupal_get_path('theme', 'darts') . '/js/jquery.tabSlideOut.v1.3.js');
  drupal_add_js(drupal_get_path('theme', 'darts') . '/js/edit_sidebar.js');
 ...
 */
function darts_preprocess_node(&$variables) {
 ...
 */
function darts_menu_local_tasks(&$variables) {
  $output = '';
...
function darts_pager_link($variables) {
...
function darts_textarea($variables) {
  $element = $variables['element'];
...
function darts_form_element($variables) {
  $element = &$variables['element'];
  $output = '';
...
function darts_webform_element($variables) {
  $element = &$variables['element'];
  // This function is invoked as theme wrapper, but the rendered form element
  // may not necessarily have been processed by form_builder().
  $element += array(
 ...
 */
function darts_form_element_label($variables) {
  $element = $variables['element'];
...
function darts_button($variables) {
  $element = $variables['element'];
...
function darts_date_popup($vars) {
...
function darts_status_messages($variables) {
